  ...
  <view>
      ...
      <table class="w-max color-light fn-sm">
          ...
          <td class="p-r-md">
            <view class="d-flex justify-end align-center">
              ...
              <van-count-down
				...
				:benginTime="current_scene.begin_time"
        ...
        <tr class="bg-panel-3">
          ...
          <td class="p-r-md">
            <view class="d-flex justify-end align-center">
              <van-icon name="clock-o m-r-xs" />
              <van-count-down @finish="$emit('change-venue')" :benginTime="next_scene.begin_time" :time="next_scene.lottery_time*1000" />
            </view>
          </td>
        </tr>
      </table>
    ...
    <view class="bg-panel-3 p-b-lg">
      ...
      <view class="btn-group d-flex p-x-md p-y-xs">
        ...
        <v-button type="default" block class="flex-fill rounded-xs btn m-x-md" style="background: rgba(25, 137, 250, 0.1);color: #1989fa;"  @click="$emit('buy-show',2)">{{$t('option.b0')}}</v-button>
