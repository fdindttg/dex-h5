<template>
    <view>
        ...
        <van-popup :show="show" @close="show = false" closeable position="bottom" custom-style="height:55%;width:100%;overflow:auto;">
            <view>
        ...
        <van-popup :show="stoplossShow" @close="stoplossShow = false" closeable position="bottom" custom-style="height:55%;width:100%:overflow:auto;">
            <view>
                <view class="p-y-xs p-x-md border-b d-flex align-center">
